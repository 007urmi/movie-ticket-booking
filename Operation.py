...
import math
mydb = mysql.connector.connect(host="localhost",user = "root", password = "0812", database = "MOVIE")
...
class Movie:
    ...
    def show_statistics(self,row,seats):
        global total_income
        total_income = 0
        print("Number of purchased tickets:",booked_ticket)
        divisor = row * seats
        per_of_booked_ticket = (booked_ticket /divisor)*100
        print("Percentage:",str(round(per_of_booked_ticket,2))+"%")
